...
@section('content')
    <main class="p-4 md:p-6">
        <!-- Header Section -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-800 dark:text-white mb-2">Tambah Pengguna Baru</h1>
            <p class="text-gray-600 dark:text-gray-300">Tambahkan pengguna baru ke dalam sistem</p>
        </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        <label for="nama" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Nama
                            Lengkap <small class="text-red-600">*</small></label>
                    ...
                    <div>
                        <label for="username"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Username<small
                    ...
                    <div>
                        <label for="no_hp" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Nomor
                            HP <small class="text-red-600">*</small></label>
                    ...
                    <div>
                        <label for="password"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Password <small
                                class="text-red-600">*</small></label>
                    ...
                    <div>
                        <label for="password_confirmation"
                            ...
                            Password <small class="text-red-600">*</small></label>
